                ...
                <tbody class="c">
                      @isset($menus)
                        ...
                        <tr id='{{ $item['id'] }}'>
                          ...
                          <td>
                            <a href="{{ url('admin/manage-menu') }}/?menu={{ $item['slug'] }}" class="btn btn-xs btn-success">Manage</a>
...
<script type="text/javascript">
  ...
  $(".delc").click(function(event) {
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
          $.get('destroy-menus/'+id, function(data) {
            swalWithBootstrapButtons.fire(
              'Deleted!',
  ...
  $(".edit").click(function(event) {
    //
    var id=$(this).parents('tr').attr('id');
    $.get('{{ url('/admin/menus') }}/'+id+'/edit', function(data) {
