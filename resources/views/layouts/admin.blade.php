...
<body style="height: auto;">
  ...
  $.fn.dataTable.ext.classes.sPageButton = '';
    ...
    tinymce.init({
      selector: '.editor1',
      plugins: 'advlist autolink lists link image charmap print preview hr anchor pagebreak table fullscreen code emoticons insertdatetime importcss searchreplace media toc wordcount',
